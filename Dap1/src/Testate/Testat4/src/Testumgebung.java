public class Testumgebung
{
    public static void main( String args[] )
    {
        ...
        // Beispiel 1
        Fraction[] arr1 = { new Fraction(1,2), new Fraction(1,2), new Fraction(1,2), new Fraction(1,2), new Fraction(1,2), new Fraction(1,2), new Fraction(1,2), new Fraction(5), new Fraction(10), new Fraction(1) };
        Fraction f1 = new Fraction(2,3);
        System.out.println( Testat.apply( arr1, f1, 9 ).toString() );

        //Beispiel 2
        Fraction[] arr2 = { new Fraction(1,3), new Fraction(1,3), new Fraction(11,6), new Fraction(1), new Fraction(1,3), new Fraction(1,3), new Fraction(1,3), new Fraction(1,3)};
        Fraction f2 = new Fraction(7,9);
        System.out.println( Testat.apply( arr2, f2, 7 ).toString() );
        
        //Beispiel 3
        Fraction[] arr3 = { new Fraction(2,23), new Fraction(2,23), new Fraction(8,7) };
        Fraction f3 = new Fraction(1,2);
        System.out.println( Testat.apply( arr3, f3, 2 ).toString() );
        
        //Beispiel 4
        Fraction[] arr4 = { new Fraction(2,9), new Fraction(2,9) };
        Fraction f4 = new Fraction(1,2);
        System.out.println( Testat.apply( arr4, f4, 1 ).toString() );
